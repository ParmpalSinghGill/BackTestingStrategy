"""
Full 6x6 Confusion Matrix & Classification Metrics Generator for Streamlined 6-Class ML Selector Model

6 Target Classes:
- Class 0: SkipTrade (Fails at 1:2 RR Target, hits SL)
...
Exports 6x6 Heatmaps and Classification Reports cleanly to Reports/ and Reports/Plots/.
"""
...
from src.analysis.run_streamlined_multi_class_benchmark import prepare_streamlined_6class_dataset

plt.style.use("seaborn-v0_8-darkgrid" if "seaborn-v0_8-darkgrid" in plt.style.available else "default")
plt.rcParams["font.family"] = "sans-serif"


def generate_full_6x6_confusion_matrix():
    print("=========================================================================")
    print("GENERATING FULL 6x6 CONFUSION MATRIX & EVALUATION METRICS FOR ML SELECTOR")
    print("=========================================================================\n", flush=True)
    ...
    print("Running Expanding Window Walk-Forward 6x6 Predictions...", flush=True)
    ...
    for test_year in years:
        ...
        y_test = test_df["Streamlined_6Class_Label"].values
        ...
        for yt, p0, p1, p2 in zip(y_test, prob_0, prob_1, prob_2):
            if p2 >= 0.48:
                yp = 2  # 1:3+
            elif (p1 + p2) >= 0.42:
                yp = 1  # 1:2
    ...
    # Map labels to 6 classes for 6x6 matrix representation
    ...
    print("\n=========================================================================")
    print("FULL 6x6 RAW CONFUSION MATRIX (TRADE COUNTS)")
    print("=========================================================================")
    ...
    out_csv = REPORTS_DIR / "Confusion_Matrix_6x6_Classification_Report.csv"
    ...
    plt.suptitle("Full 6x6 Confusion Matrix Evaluation: Streamlined Dynamic ML Selector Model", fontsize=14, fontweight="bold", y=0.98)
    fig.tight_layout()

    out_png = PLOTS_DIR / "Confusion_Matrix_6x6_ML_Selector.png"
...
if __name__ == "__main__":
    generate_full_6x6_confusion_matrix()
