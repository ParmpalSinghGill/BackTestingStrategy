"""
Generate High-Resolution OHLC Candlestick Trade Plots for the Optimal Top 5 Strategy
--------------------------------------------------------------------------------------
Enhancement: Annotate exact TIME and PRICE on Entry, Exit 1, and Exit 2 labels.
Output Directory: plot/Plot_15M/
"""
...
def main():
    print("==========================================================================")
    print(" GENERATING ENHANCED CANDLESTICK CHARTS WITH TIME & PRICE LABELS         ")
    print("==========================================================================")
    ...
    print(f"Loaded {len(trades_df)} trade entries from {trades_csv.name}.")
    
    # Pre-clean existing plots in PLOTS_DIR
    ...
    print(f"\nSuccessfully generated {count} OHLC Candlestick trade plot charts with TIME & PRICE labels in {PLOTS_DIR}!")
