"""
Swing Strategy Engine: Jan 01, 2012 Start Window Strategy (2012 to 2026)

Configuration:
- 33 Feature Matrix
- Initial Deposit: Rs 100,000.00 starting Jan 01, 2012
- Max Risk Cap: Rs 1,000.00 per trade
- Model Retraining: Every Jan 01 annually (expanding window up to Dec 31 of year Y-1)
...
print(f"=== Jan 01, 2012 Start Strategy (33 Features | 2012 to 2026) ===", flush=True)

# Retraining Years: 2012 to 2026
...
exp_name = "Single_4Class_Jan2012_Start_Model"
